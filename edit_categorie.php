<?php
$page_title = 'Redaguoti kategoriją';
...
if (isset($_POST['edit_cat'])) {
    ...
    if (empty($errors)) {
        ...
        if ($result && $db->affected_rows() === 1) {
            $session->msg("s", "Sėkmingai atnaujinta kategorija");
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>
                    ...
                    <span>Redagavimas <?php echo remove_junk(ucfirst($categorie['name'])); ?></span>
                </strong>
            </div>
            <div class="panel-body">
                <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id']; ?>">
                    ...
                    <button type="submit" name="edit_cat" class="btn btn-primary">Atnaujinti kategoriją</button>
                </form>
            </div>
        </div>
    </div>
