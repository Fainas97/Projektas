...
if (isset($_POST['add_cat'])) {
    ...
    if (empty($errors)) {
        ...
        $sql .= " VALUES ('{$cat_name}')";
        if ($db->query($sql)) {
            $session->msg("s", "Sėkmingai pridėta kategorija");
            redirect('categorie.php', false);
        } else {
            $session->msg("d", "Atsiprašome, nepavyko įterpti.");
            redirect('categorie.php', false);
        }
    } else {
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>
                    ...
                    <span>Pridėti naują kategoriją</span>
                </strong>
            </div>
            <div class="panel-body">
                <form method="post" action="categorie.php">
                    ...
                    <button type="submit" name="add_cat" class="btn btn-primary">Pridėti kategoriją</button>
                </form>
            </div>
        </div>
    </div>
