<?php
$page_title = 'Redaguoti pardavimą';
...
if (!$sale) {
    $session->msg("d", "Trūksta produkto ID.");
    redirect('sales.php');
}
?>
        ...
        <div class="panel">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="sales.php" class="btn btn-primary">Rodyti visus pardavimus</a>
                </div>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                            ...
                            <td>
                                <button type="submit" name="update_sale" class="btn btn-primary">Atnaujinti pardavimą
                                </button>
                            </td>
                        </form>
                    </tr>
